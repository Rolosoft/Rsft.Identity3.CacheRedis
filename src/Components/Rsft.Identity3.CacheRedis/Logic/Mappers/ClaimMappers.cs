...
namespace Rsft.Identity3.CacheRedis.Logic.Mappers
{
    ...
    /// The Claim Mappers
    /// </summary>
    internal static class ClaimMappers
    {
        /// <summary>
        ...
        public static SimpleClaim ToSimpleEntity(this Claim source)
        {
            if (source == null)
            {
                return null;
        ...
        /// <param name="source">The source.</param>
        /// <returns>The <see cref="SimpleClaim"/></returns>
        public static IEnumerable<SimpleClaim> ToSimpleEntity(this IEnumerable<Claim> source)
        {
